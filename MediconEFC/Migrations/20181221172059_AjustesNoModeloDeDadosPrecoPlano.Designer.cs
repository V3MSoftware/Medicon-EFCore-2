...
namespace MediconEFC.Migrations
{
    ...
    [Migration("20181221172059_AjustesNoModeloDeDadosPrecoPlano")]
    partial class AjustesNoModeloDeDadosPrecoPlano
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediconEFC.Models.AbrangenciaPlano", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MediconEFC.Models.PrecoPlano", b =>
                {
                    ...
                    b.Property<int>("AbrangenciaPlanoId");
                    ...
                    b.HasIndex("AbrangenciaPlanoId");

                    b.HasIndex("FaixaEtariaId");

                    b.HasIndex("TipoAcomodacaoId");
            ...
            modelBuilder.Entity("MediconEFC.Models.TipoAcomodacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TipoAcomodacao");
                });

            modelBuilder.Entity("MediconEFC.Models.TipoContrato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MediconEFC.Models.TipoPlano", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MediconEFC.Models.PrecoPlano", b =>
                {
                    b.HasOne("MediconEFC.Models.AbrangenciaPlano", "AbrangenciaPlano")
                        .WithMany()
                        .HasForeignKey("AbrangenciaPlanoId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("MediconEFC.Models.TipoAcomodacao", "TipoAcomodacao")
                        .WithMany()
                        .HasForeignKey("TipoAcomodacaoId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MediconEFC.Models.TipoContrato", "TipoContrato")
                        .WithMany()
                        .HasForeignKey("TipoContratoId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MediconEFC.Models.TipoPlano", "TipoPlano")
                        .WithMany()
